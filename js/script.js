...
const giay = [
  ...
  },
  {
    id: 8,
    token: "giay-8",
    name: "Giày Đá Bóng Sân Cỏ Nhân Tạo X",
  ...
  },
  {
    id: 16,
    token: "giay-16",
    name: "Giày Ultraboost 21 x Parley",
            ...
            <div class="card" style="width: 100%">
                <div>
                    <img class="card-img-top" src= ${
                      item.img
                    } alt="Card image cap"  onclick = "getDetailProduct(sanphammoi,${
      item.id
    })">
                ...
                <div class="card-body">
                    ...
                    <div class="select-swap">
                        <div class="swatch-element" data-value="38" >
                            <input type="radio" class="variant-1" id="swatch-sanphamoi-${
                              item.id
                            }-1" name="mau"
                                value="S" >
                            <label for="swatch-sanphamoi-${
                              item.id
                            ...
                            <div class="product__amount w-100">
                                <div class="product__wap-change d-flex justify-content-center">
                                    <p for="" class = "soluong">Nhập số lượng: </p>
                                        <input type="text" value = "1"  class="text-input" id="text_so_luong-sanphammoi-${
                                          item.id
                                        }">
                                </div>
                            </div>
        ...
        <div class="product__new-item">
            <div class="card" style="width: 100%">
                <div>
                    <img class="card-img-top" src= ${
                      item.img
                    } alt="Card image cap"  onclick = "getDetailProduct(sanphamhot,${
      item.id
    })">
                ...
                <div class="card-body">
                    ...
                    <div class="select-swap">
                        <div class="swatch-element" data-value="38" >
                            <input type="radio" class="variant-1" id="swatch-sanphamhot-${
                              item.id
                            }-1" name="mau"
                                value="S" >
                            <label for="swatch-sanphamhot-${
                              item.id
                            }-1" class="sd"><span>38</span></label>
                        </div>
                        <div class="swatch-element" data-value="39">
                      ...
                      <div class="product__wrap">
                            <div class="product__amount w-100">
                                <div class="product__wap-change d-flex justify-content-center">
                                    <p for="" class = "soluong">Nhập số lượng: </p>
                                        <input type="text" value = "1"  class="text-input" id="text_so_luong-sanphamhot-${
                                          item.id
                                        }">
                                </div>
                            </div>
                        ...
                        <div class="product__shopnow">
                            <button class="shopnow2" onclick = "getProduct(sanphamhot,${
                              item.id
        ...
        <div class="product__new-item">
            <div class="card" style="width: 100%">
                <div>
                    <img class="card-img-top" src= ${
                      item.img
                    } alt="Card image cap"  onclick = "getDetailProduct(bansethich,${
      item.id
    })">
                ...
                <div class="card-body">
                    ...
                    <div class="select-swap">
                        <div class="swatch-element" data-value="38" >
                            <input type="radio" class="variant-1" id="swatch-bansethich-${
                              item.id
                            }-1" name="mau"
                                value="S" >
                            <label for="swatch-bansethich-${
                              item.id
                            }-1" class="sd"><span>38</span></label>
                        </div>
                        <div class="swatch-element" data-value="39">
                      ...
                      <div class="product__wrap">
                            <div class="product__amount w-100">
                                <div class="product__wap-change d-flex justify-content-center">
                                    <p for="" class = "soluong">Nhập số lượng: </p>
                                        <input type="text" value = "1"  class="text-input" id="text_so_luong-bansethich-${
                                          item.id
                                        }">
                                </div>
                            </div>
                        ...
                        <div class="product__shopnow">
                            <button class="shopnow2" onclick = "getProduct(bansethich,${
                              item.id
      ...
      <img class="card-img-top" src= ${item.img} alt="Card image cap" 
       onclick = "getDetailProduct(ao,${item.id})">
              ...
              <div class="card-body">
                  ...
                  <div class="product__shopnow">
                  <button class="shopnow2" onclick = "getProduct(ao,${
                    item.id
                  },'ao')">Mua ngay</button>
                  </div>
              </div>
          ...
          <img class="card-img-top" src= ${item.img} alt="Card image cap" 
           onclick = "getDetailProduct(quan,${item.id})">
              ...
              <div class="card-body">
                  ...
                  <div class="product__shopnow">
                  <button class="shopnow2" onclick = "getProduct(quan,${
                    item.id
          ...
          <img class="card-img-top" src= ${item.img} alt="Card image cap" 
           onclick = "getDetailProduct(giay,${item.id})">
              ...
              <div class="card-body">
                  ...
                  <div class="product__shopnow">
                  <button class="shopnow2" onclick = "getProduct(giay,${
                    item.id
  ...
  <div class="row product__detail-row d-flex justify-content-between">
     <div class="col-xl-6" id="main-img" style="cursor: pointer;">
                ...
                <div class="status-product">
                        ...
                        <div class="select-swap">
                        <div class="swatch-element" data-value="38">
                            <input type="radio" class="variant-1" id="swatch-${
                              value.img
                            }-38" name="mau"
                                value="S">
                            <label for="swatch-${
